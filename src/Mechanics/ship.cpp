...
enum class SensorType {
    Speed,            // Absolute value of Speed
    Speed_Angle,      // Current angle of resulting speed
...
class Ship : public Entity {
    ...
    {   
        ...
        float distance_reward = abs_speed * 0.8f; 
        ...
        score*=(1-stop_penalty);
        
        // Ensures score never becomes negative
        if (score < 0) score = 0;
    }
    
    void set_melhor_nave(){ best = true; }
