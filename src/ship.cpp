...
class Ship{
    ...
    public:
        ...
        void movement(string decision){
            if (decision == "ROTATE_RIGHT") shipangularvelocity += ship_angular_acceleration;
            if (decision == "ROTATE_LEFT") shipangularvelocity -= ship_angular_acceleration;
